...
def lalala(message):
    if message.chat.type == 'private':
        if message.text == 'Homework':
          ...
          markup.add(bazapush, bazapull, bazachest1, bazaspina1, bazachest2, bazaspina2, bazachest3, bazaspina3, bazanogi1, bazapress1, bazanogi2, bazapress2, bazanogi3, bazapress3)
