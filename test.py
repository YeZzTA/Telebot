...
def lalala(message):
    if message.chat.type == 'private':
        if message.text == 'Пойду делать домашку':
            ...
            bot.send_message(message.chat.id, 'Ты выбрал передний вис! Теперь укажи свой уровень: ', reply_markup = markup)
